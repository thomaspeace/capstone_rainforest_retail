          ...
          <Nav className="van-list-nav">
            ...
            <Navbar.Text className="van-list-nav-item">
              <Dropdown>
                ...
                <Dropdown.Menu>
                  <Dropdown.Item className='van-list-dropdown-item' onClick={() => handleRegionSelect('All')}>All</Dropdown.Item>
                  {regions.map((region, index) => (
                    <Dropdown.Item className='van-list-dropdown-item' key={index} onClick={() => handleRegionSelect(region)}>
                      {region}
                    </Dropdown.Item>
                  ))}
                </Dropdown.Menu>
              ...
              <Card className="van-list-card">
                <Card.Body>
                  ...
                  <Button
                    ...
                    as={Link}
                    to={`/vans/${van.id}`}
                    disabled={!(van.clusteredOrder?.listOfOrders?.length > 0)}
                  > Go to Van </Button>
